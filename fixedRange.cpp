...
// 101
// 133
// Note: For this activity, using one statement may yield different output
// (due to the compiler calling rand() in a different order). Use two statements for this activity.
